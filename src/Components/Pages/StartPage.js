                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <div class="container">
                        <div style={{ width: 40, height: 40 }}>
                            <img class="img-fluid rounded-circle mb-4" src={carbookLogo} alt="carbook logo" />
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item"><a class="nav-link" href="/api/add-owner">Register Solo Client</a></li>
                                <li class="nav-item"><a class="nav-link" href="/api/add-workshops">Register Company Client</a></li>
